  ...
  cloud: {
    bucket: {
      name: {
        ...
        format: String,
        default: 'cliniciandevapp.appspot.com', // TODO: revert to null
        env: 'STORAGE_BUCKET',
      },
      httpsBaseURL: {
    ...
    project: {
      id: {
        ...
        format: String,
        default: 'cliniciandevapp', // TODO: revert to null
        env: 'PROJECT_ID',
      },
      name: {
    ...
    pubsubService: {
      publisherTopic: {
        doc: 'Input Pub/Sub topic for the publisher',
        default: 'video-transcripts',
      },
      subscriberTopic: {
        doc: 'Output Pub/Sub topic for the subscriber',
        default: 'llm-output',
      },
    },
  },
  firebase: {
    ...
    firestore: {
      ...
      questionnaireCollection: {
        doc: 'Firestore collection for questionnaire data',
        default: 'questionnaire_draft',
      },
      sessionSummaryCollection: {
        doc: 'Firestore collection for session summary data',
        default: 'summary',
      },
